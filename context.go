...
func hello(w http.ResponseWriter, req *http.Request) {
	...
	// the net/http machinery, and is available with the
	// Context() method.
	ctx := req.Context()
	...
	// While working, keep an eye on the context’s Done() channel for
	// a signal that we should cancel the work and return as soon as possible.
	select {
...
func main() {
	...
	// We register our handler on the “/hello” route, and start serving.
