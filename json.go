//
// Go by Example: JSON - gobyexample.com
// json.go
//
package main
...
func main() {
	...
	// Check the definition of response2 above to see an example of
	// such tags.
	res2D := &response2{
		Page:   1,
		Fruits: []string{"apple", "peach", "pear"}}
	...
	// This map[string]interface{} will hold a map of strings
	...
	// as intermediates between the data and JSON representation
	// on standard out. We can also stream JSON encodings directly
