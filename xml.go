//
// Go by  Example:  XML - gobyexample.com/xml
// xml.go
//
package main
...
// Here we use some special features of the XML package: the XMLName
// field name dictates the name of the XML element representing this struct;
// id,attr means that the Id field is an XML attribute rather than a nested
// element.
