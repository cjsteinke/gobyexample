...
func main() {
	...
	// Tesst whether a pattern matches a string.
	match, _ := regexp.MatchString("p([a-z]+)ch", "peach")
	fmt.Println(match)

	// Above we used a string pattern directly,
	// but for other regexp tasks you’ll need to
	...
	// When creating global variables with regular expressions you can use
	// the MustCompile variation of Compile.
